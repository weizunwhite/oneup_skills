...
1. **Adjacent slides must use DIFFERENT layout types** — even within the same 板块
2. **Same 板块 multi-page rule:** If a 板块 has 2+ pages, each page MUST use a different layout. E.g., 选题缘由 page 1 uses Story Cards, page 2 uses Photo + List
3. Don't use card-grid layout more than twice in the entire presentation
4. At least ONE slide should feature a photo prominently
5. Cover and closing should share visual theme (same dark/light bg, same decorative elements)
6. Data-heavy slides (背景调研, 测试与结果) should use DIFFERENT data layouts from each other

**Recommended layout combinations within multi-page 板块s:**

| 板块 | Page 1 Layout | Page 2 Layout | Page 3 Layout |
|------|---------------|---------------|---------------|
| ① 选题缘由 | Story Cards (Origin-A) | Photo+List or Data Cards (Origin-B/C) | — |
| ② 研究设计 | Flow Diagram (Design-A/B/C) | Photo+List (Content-B) | Card Grid (Content-A) |
| ③ 过程及结果 | Timeline (Process-A/B/C) | Comparison Arrows | Hero Numbers |
